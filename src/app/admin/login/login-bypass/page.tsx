    ...
    try {
      ...
      if (response.ok) {
        ...
        if (data.success) {
          ...
          setTimeout(() => {
            router.push('/admin/dashboard-bypass')
          }, 1000)
        }
      }
    } catch (error) {
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Direct admin authentication (bypasses NextAuth)
            </p>
          </div>
          ...
          <div className="mt-8 pt-6 border-t border-gray-200 dark:border-gray-700">
            <div className="text-center space-y-2">
              <p className="text-xs text-gray-500">
                This bypasses NextAuth and uses direct JWT authentication
              </p>
              <Link
                href="/"
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-yellow-800">
                <strong>Admin Access Only:</strong> This is a direct admin authentication system.
                Credentials: saurabh2000@gmail.com / Admin@2025!
              </p>
            </div>
          </div>
        </div>
